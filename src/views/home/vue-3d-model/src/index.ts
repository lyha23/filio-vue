...
const components = [ModelObj, ModelFbx, ModelThree, ModelJson, ModelStl, ModelPly, ModelCollada, ModelDae, ModelGltf];
...
export { install, ModelObj, ModelFbx, ModelThree, ModelJson, ModelStl, ModelPly, ModelCollada, ModelDae, ModelGltf };
