...
import { type IDesktop, MENULINKS, NO_MOTION_PREFERENCE_QUERY, PROJECTS } from '/@/constants';
...
<template>
  ...
  >
    ...
    <div ref="sectionTitleElementRef" :class="`flex flex-col inner-container  ${willChange && 'will-change-transform'}`">
      <p class="seq section-title-sm">PROJECTS</p>
      <h1 class="seq section-heading mt-2">My Works</h1>
