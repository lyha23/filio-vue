...
import { NO_MOTION_PREFERENCE_QUERY, isSmallScreen } from '@/constants';
...
const initTextGradientAnimation = (targetSection: Ref<HTMLElement | undefined>): ScrollTrigger => {
...
const initSlidingTextAnimation = (targetSection: Ref<HTMLElement | undefined>) => {
