...
const initTypeAnimation = (typedSpanElement: Ref<HTMLElement | undefined>): Typed => {
...
const initRevealAnimation = (targetSection: Ref<HTMLElement | undefined>): GSAPTimeline => {
    ...
    <section :id="heroSectionRef" ref="targetSection" :class="HERO_STYLES.SECTION" style="opacity: 100">
      <div :class="HERO_STYLES.CONTENT">
        <div class="mb-2 md:mb-4">
          <h2 class="seq text-4xl">Hello 👋🏻</h2>
          <h1 class="seq text-3xl">I am Ayush Singh</h1>
        </div>
        <p class="mb-4">
